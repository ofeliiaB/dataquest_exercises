...
industry_usa = f500.loc[usa_filter, :].loc[:,"industry"].value_counts().head(2)



china_filter = f500["country"] == "China"
sector_china = f500.loc[china_filter, :].loc[:, "sector"].value_counts().head(3)
...
#industries_usa = f500["industry", usa_filter]
