...
mean_distance = sum(cleaned_taxi[:,7])/ cleaned_taxi[:,7].shape[0]

mean_length = sum(cleaned_taxi[:,8])/ cleaned_taxi[:,8].shape[0]


mean_total_amount = sum(cleaned_taxi[:,13])/ cleaned_taxi[:,13].shape[0]