...
with open('ign.csv', 'r') as f:
    ...
    for row in reader:
        ...
        score_phrase = row[1]
        if(len(score_phrase) > max_len):
            max_len = len(score_phrase)
...
cur.execute("""
    ...
    'Disaster',    'Painful');
""")
query = "ALTER TABLE ign_reviews ALTER COLUMN score_phrase TYPE evaluation_enum USING score_phrase::evaluation_enum"
